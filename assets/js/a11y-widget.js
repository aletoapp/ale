...
(function () {
  ...
  function openModal (e) {
    // preventDefault: se o gatilho for um <a href="..."> ou um <button>
    // sem type="button" dentro de um <form>, o navegador tentaria seguir
    // o link/submeter o form (rolando a página) além de abrir o modal.
  ...
  overlay.addEventListener('click', function (e) { if (e.target === overlay) closeModal(e); });
  document.addEventListener('keydown', function (e) { if (e.key === 'Escape' && overlay.classList.contains('open')) closeModal(e); });
}());
